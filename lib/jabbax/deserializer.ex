defmodule Jabbax.Deserializer do
  ...
  defp deserialize_relationship(data_list) when is_list(data_list),
    do: deserialize_data(data_list)
  ...
  defp dig_and_deserialize_error_source(%{"source" => source}),
    do: deserialize_error_source(source)
